...
| 対象 | モデル | 売買ログ | Slack通知 |
| --- | --- | --- | --- |
| `target_stock`（8306） | `models/stock_ai_model.pkl` | `data/trade_log_8306.csv` | あり |
| `log_only_stocks` | `models/monitoring/stock_ai_model_<code>.pkl` | `data/trade_log_<code>.csv` | なし |
